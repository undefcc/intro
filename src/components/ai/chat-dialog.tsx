...
export default function ChatDialog() {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="w-[95vw] sm:max-w-4xl lg:max-w-5xl max-h-[85vh] flex flex-col">
        ...
        <PromptInput onSubmit={handleSubmit}>
          ...
          />
          <PromptInputToolbar>
            <PromptInputSubmit disabled={!input.trim()} status={loading ? 'streaming' : undefined} />
          </PromptInputToolbar>
        </PromptInput>
      </DialogContent>
    </Dialog>
